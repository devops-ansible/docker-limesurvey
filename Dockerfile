...
ENV LIMESURVEY_CURRENT_DOWNLOADFILE="https://www.limesurvey.org/stable-release?download=2389:limesurvey3100%20180611targz"
ENV RUNTIMEFOLDER="/var/www/limesurvey"

RUN wget $LIMESURVEY_CURRENT_DOWNLOADFILE -O /tmp/limesurvey.tar.gz
RUN tar xfz /tmp/limesurvey.tar.gz  --strip=1 -C /var/www/html
